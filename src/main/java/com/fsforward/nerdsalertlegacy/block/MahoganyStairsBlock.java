...
public class MahoganyStairsBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:mahogany_stairs")
	public static final Block block = null;

	public MahoganyStairsBlock(NerdsalertLegacyModElements instance) {
		super(instance, 106);
	}
