...
public class BlackAshTrapdoorBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:black_ash_trapdoor")
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("black_ash_trapdoor");
		}
