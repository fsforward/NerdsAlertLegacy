...
public class BlackAshButtonBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:black_ash_button")
	public static final Block block = null;

	public BlackAshButtonBlock(NerdsalertLegacyModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("black_ash_button");
		}
