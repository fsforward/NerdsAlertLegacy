...
public class BlackAshSlabBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:black_ash_slab")
	public static final Block block = null;

	public BlackAshSlabBlock(NerdsalertLegacyModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_ash_slab");
		}
