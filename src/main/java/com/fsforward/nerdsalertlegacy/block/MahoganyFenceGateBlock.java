...
public class MahoganyFenceGateBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:mahogany_fence_gate")
	public static final Block block = null;

	public MahoganyFenceGateBlock(NerdsalertLegacyModElements instance) {
		super(instance, 84);
	}
