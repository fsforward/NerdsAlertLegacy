...
public class StrippedBlackAshWoodBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:stripped_black_ash_wood")
	public static final Block block = null;

	public StrippedBlackAshWoodBlock(NerdsalertLegacyModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_black_ash_wood");
		}
