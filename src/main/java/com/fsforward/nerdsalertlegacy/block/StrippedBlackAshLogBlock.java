...
public class StrippedBlackAshLogBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:stripped_black_ash_log")
	public static final Block block = null;

	public StrippedBlackAshLogBlock(NerdsalertLegacyModElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_black_ash_log");
		}
