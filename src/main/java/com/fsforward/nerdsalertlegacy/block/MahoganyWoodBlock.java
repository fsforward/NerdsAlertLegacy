...
public class MahoganyWoodBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:mahogany_wood")
	public static final Block block = null;

	public MahoganyWoodBlock(NerdsalertLegacyModElements instance) {
		super(instance, 79);
	}
