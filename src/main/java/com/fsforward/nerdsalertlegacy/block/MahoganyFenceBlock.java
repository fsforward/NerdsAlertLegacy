...
public class MahoganyFenceBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:mahogany_fence")
	public static final Block block = null;

	public MahoganyFenceBlock(NerdsalertLegacyModElements instance) {
		super(instance, 85);
	}
