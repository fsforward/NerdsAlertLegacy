...
public class MahoganyLeavesBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:mahogany_leaves")
	public static final Block block = null;

	public MahoganyLeavesBlock(NerdsalertLegacyModElements instance) {
		super(instance, 113);
	}
