...
public class TycholaOreBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:tychola_ore")
	public static final Block block = null;

	public TycholaOreBlock(NerdsalertLegacyModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(TycholaTabItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("nerdsalert_legacy:tychola_ore_match"),
