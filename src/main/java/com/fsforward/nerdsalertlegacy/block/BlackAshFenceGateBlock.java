...
public class BlackAshFenceGateBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:black_ash_fence_gate")
	public static final Block block = null;

	public BlackAshFenceGateBlock(NerdsalertLegacyModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("black_ash_fence_gate");
		}
