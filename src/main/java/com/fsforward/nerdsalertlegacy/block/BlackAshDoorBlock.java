...
public class BlackAshDoorBlock extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:black_ash_door")
	public static final Block block = null;

	public BlackAshDoorBlock(NerdsalertLegacyModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("black_ash_door");
		}
