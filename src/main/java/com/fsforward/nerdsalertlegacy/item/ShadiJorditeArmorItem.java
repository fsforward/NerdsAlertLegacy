...
public class ShadiJorditeArmorItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:shadi_jordite_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("nerdsalert_legacy:shadi_jordite_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("nerdsalert_legacy:shadi_jordite_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("nerdsalert_legacy:shadi_jordite_armor_boots")
	public static final Item boots = null;

	public ShadiJorditeArmorItem(NerdsalertLegacyModElements instance) {
		super(instance, 32);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{5, 6, 9, 5}[slot.getIndex()];
			}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ShadiTabItemGroup.tab).isImmuneToFire()) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "nerdsalert_legacy:textures/models/armor/shadi_jordite__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1")
								+ ".png";
					}
										@Override
					@OnlyIn(Dist.CLIENT)
				...
				}.setRegistryName("shadi_jordite_armor_helmet"));
		elements.items.add(
				...
				}.setRegistryName("shadi_jordite_armor_chestplate"));
		elements.items
				...
				}.setRegistryName("shadi_jordite_armor_leggings"));
		elements.items
				...
				}.setRegistryName("shadi_jordite_armor_boots"));
	}
