...
public class ShadiJorditeHoeItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:shadi_jordite_hoe")
	public static final Item block = null;

	public ShadiJorditeHoeItem(NerdsalertLegacyModElements instance) {
		super(instance, 31);
	}
	...
	public void initElements() {
		...
		}, 0, 1f, new Item.Properties().group(ShadiTabItemGroup.tab).isImmuneToFire()) {
			@Override
			@OnlyIn(Dist.CLIENT)
		...
		}.setRegistryName("shadi_jordite_hoe"));
	}
}
