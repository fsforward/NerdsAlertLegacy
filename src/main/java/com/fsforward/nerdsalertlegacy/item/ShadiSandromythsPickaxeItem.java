...
public class ShadiSandromythsPickaxeItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:shadi_sandromyths_pickaxe")
	public static final Item block = null;

	public ShadiSandromythsPickaxeItem(NerdsalertLegacyModElements instance) {
		super(instance, 35);
	}
	...
	public void initElements() {
		...
		}, 1, -2.75f, new Item.Properties().group(ShadiTabItemGroup.tab).isImmuneToFire()) {
			@Override
			@OnlyIn(Dist.CLIENT)
		...
		}.setRegistryName("shadi_sandromyths_pickaxe"));
	}
}
