...
public class ShadiJorditePickaxeItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:shadi_jordite_pickaxe")
	public static final Item block = null;

	public ShadiJorditePickaxeItem(NerdsalertLegacyModElements instance) {
		super(instance, 29);
	}
	...
	public void initElements() {
		...
		}, 1, -2.5f, new Item.Properties().group(ShadiTabItemGroup.tab).isImmuneToFire()) {
			@Override
			@OnlyIn(Dist.CLIENT)
		...
		}.setRegistryName("shadi_jordite_pickaxe"));
	}
}
