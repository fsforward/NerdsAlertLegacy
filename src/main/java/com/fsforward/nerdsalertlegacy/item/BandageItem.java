...
import com.fsforward.nerdsalertlegacy.procedures.BandageEntitySwingsItemProcedure;
...
public class BandageItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:bandage")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			BandageEntitySwingsItemProcedure.executeProcedure(
