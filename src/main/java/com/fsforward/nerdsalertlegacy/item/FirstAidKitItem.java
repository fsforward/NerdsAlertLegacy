...
import com.fsforward.nerdsalertlegacy.procedures.FirstAidKitRightclickedProcedure;
...
public class FirstAidKitItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:first_aid_kit")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			FirstAidKitRightclickedProcedure.executeProcedure(
