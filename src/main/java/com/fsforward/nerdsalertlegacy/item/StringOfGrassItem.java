...
public class StringOfGrassItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:string_of_grass")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("string_of_grass");
		}
