...
public class ShadiTycholaShovelItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:shadi_tychola_shovel")
	public static final Item block = null;

	public ShadiTycholaShovelItem(NerdsalertLegacyModElements instance) {
		super(instance, 261);
	}
	...
	public void initElements() {
		...
		}, 1, -2.8f, new Item.Properties().group(TycholaTabItemGroup.tab).isImmuneToFire()) {
			@Override
			@OnlyIn(Dist.CLIENT)
		...
		}.setRegistryName("shadi_tychola_shovel"));
	}
}
