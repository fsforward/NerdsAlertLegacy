...
public class ShadiSandromythsHoeItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:shadi_sandromyths_hoe")
	public static final Item block = null;

	public ShadiSandromythsHoeItem(NerdsalertLegacyModElements instance) {
		super(instance, 37);
	}
	...
	public void initElements() {
		...
		}, 0, 0.75f, new Item.Properties().group(ShadiTabItemGroup.tab).isImmuneToFire()) {
			@Override
			@OnlyIn(Dist.CLIENT)
		...
		}.setRegistryName("shadi_sandromyths_hoe"));
	}
}
