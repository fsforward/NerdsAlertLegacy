...
public class ShadiTycholaPickaxeItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:shadi_tychola_pickaxe")
	public static final Item block = null;

	public ShadiTycholaPickaxeItem(NerdsalertLegacyModElements instance) {
		super(instance, 262);
	}
	...
	public void initElements() {
		...
		}, 1, -1.7f, new Item.Properties().group(TycholaTabItemGroup.tab).isImmuneToFire()) {
			@Override
			@OnlyIn(Dist.CLIENT)
		...
		}.setRegistryName("shadi_tychola_pickaxe"));
	}
}
