...
public class CodFishTinCanItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:cod_fish_tin_can")
		...
		public ItemCustom() {
			super(new Item.Properties().group(FoodTabItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(5).saturation(1f)
							...
							.build()));
			setRegistryName("cod_fish_tin_can");
		}
