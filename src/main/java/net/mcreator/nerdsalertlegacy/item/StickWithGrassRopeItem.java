...
public class StickWithGrassRopeItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:stick_with_grass_rope")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("stick_with_grass_rope");
		}
