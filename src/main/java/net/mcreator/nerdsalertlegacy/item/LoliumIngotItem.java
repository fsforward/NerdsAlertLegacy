...
public class LoliumIngotItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:lolium_ingot")
	public static final Item block = null;

	public LoliumIngotItem(NerdsalertLegacyModElements instance) {
		super(instance, 13);
	}
