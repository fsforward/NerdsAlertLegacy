...
public class TycholaIngotItem extends NerdsalertLegacyModElements.ModElement {
	@ObjectHolder("nerdsalert_legacy:tychola_ingot")
	public static final Item block = null;

	public TycholaIngotItem(NerdsalertLegacyModElements instance) {
		super(instance, 5);
	}
